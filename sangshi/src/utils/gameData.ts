...
export const SKILL_TEMPLATES: Record<string, Omit<Skill, 'currentCooldown'>> = {
  ...
  fierce_attack: { id: 'fierce_attack', name: '凶猛攻击', mpCost: 50, type: 'attack', power: 140, cooldown: 3, range: 1, description: '选择1格范围内的1个敌方目标，造成140%攻击力+20%当前生命值的伤害', effectType: 'fire', attribute: 'normal', category: '指定', skillTypeTag: '攻击', rangeTag: '1格', targetCountTag: '1个', damageFormula: 'atk_plus_hp_pct', hpPct: 0.2 },
  ...
  sui_xing: { id: 'sui_xing', name: '碎星', mpCost: 80, type: 'attack', power: 100, cooldown: 4, range: 4, targetCount: 1, description: '选择4格范围内的1个敌方目标，造成100%攻击力+50%当前生命值的伤害，并使目标陷入【流血】状态', effectType: 'wind', attribute: 'wind', category: '指定', damageFormula: 'atk_plus_hp_pct', hpPct: 0.5, statusEffect: 'bleeding', skillTypeTag: '攻击', rangeTag: '4格', targetCountTag: '1个' },
  miao_shou: { id: 'miao_shou', name: '妙手', mpCost: 80, type: 'heal', power: 0, cooldown: 4, range: 3, targetCount: 1, description: '选择3格菱形范围内的1个友方单位（可以选择自身），恢复生命值为当前生命值的30%，使目标获得【愈合】状态，并驱散目标所有不良状态', effectType: 'water', attribute: 'water', category: 'heal', skillTypeTag: '治疗', rangeTag: '3格', targetCountTag: '1个' },
  ...
  wenyi_chuanbo: { id: 'wenyi_chuanbo', name: '瘟疫传播', mpCost: 70, type: 'attack', power: 90, cooldown: 3, range: 0, areaRange: 1, description: '以自身为中心，对1格菱形范围内的所有敌方目标，造成90%攻击力的伤害，并使目标陷入【中毒】状态', effectType: 'water', attribute: 'water', category: 'aoe', skillTypeTag: '攻击', rangeTag: '1格', targetCountTag: 'AOE', rangeType: 'diamond', statusEffect: 'poison' },
...
export const CHARACTER_GROWTH: Record<string, CharacterGrowth> = {
  ...
  tiantu: { maxHp: 90, maxMp: 30, attack: 25, defense: 15 },
  tianniu: { maxHp: 100, maxMp: 20, attack: 30, defense: 15 },
  ...
  tianshu: { maxHp: 75, maxMp: 25, attack: 25, defense: 10 },
